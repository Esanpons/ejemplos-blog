...
codeunit 60007 "Mgt. Send Mail"
{
    ...
    begin
        ...
        ReturnValue := this.AddOneBodyToEmailMessage(ReportSelectionWarehouse.FindFirst(), ReportSelectionWarehouse."Report ID", ReportSelectionWarehouse."Email Body Layout Code");
    end;
